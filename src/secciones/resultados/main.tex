...
El cálculo en el primer informe usaba $r$ \ref{eq:error-cuadrados-minimos-r} o $R^2$ \ref{eq:error-cuadrados-minimos-formula-R2-resolucion} y los calcule en el apendice ($r = \sum_{i=0}^{k} (y_i - f(x_i))^2$) y ($R^2 = 1 - \frac{r}{\sum (y_i - \bar{y})^2}$), tengo que ver bien que hace y capaz es por ahi, aunque no se menciona en la guía.
}
