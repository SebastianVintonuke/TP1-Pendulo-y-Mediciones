...
Usando $\varepsilon_x = \Delta X / X_0$ como definición de incerteza o error relativo, y aplicando propagación de errores mediante derivadas parciales.
...
El error relativo introducido por $\pi$ ($\varepsilon_\pi = \Delta\pi / \pi_0$) proviene de recortar cifras de un número irracional.
