...
%Para pequeñas amplitudes ($\theta \ll 1$ rad, típicamente $\theta < 15°$), la ecuación de movimiento se linealiza y el período de oscilación resulta independiente tanto de la masa como de la amplitud:
%\begin{equation}
