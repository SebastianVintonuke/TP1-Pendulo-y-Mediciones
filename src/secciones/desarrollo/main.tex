...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|l|}
        \hline
        \textbf{Instrumento} & \textbf{Mínima división / Error} & \textbf{Uso en la práctica} \\ \hline
        \csvreader[
            separator=semicolon,
            head=true,
...
Para cada longitud se registró el tiempo de 20 oscilaciones ($n = 20$) en 4 amplitudes distintas ($\theta = 5\textdegree$, $9\textdegree$, $15\textdegree$ y $20\textdegree$).
En algunos casos se realizaron dos mediciones del tiempo y se tomó el promedio.
Se utilizó $n = 20$ para reducir el error relativo en la medición del tiempo $\Delta t$ disminuye con $n$, ya que la incerteza de lectura del cronómetro (principalmente el error de reacción humana, $\sim$0,1--0,2 s) se distribuye sobre un intervalo de tiempo mayor.
