...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.15\textwidth]{secciones/desarrollo/esquema-cilindro.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{secciones/desarrollo/esquema-pendulo.png}
