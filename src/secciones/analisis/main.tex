...
Tras realizar un ajuste con 12 puntos (correspondientes a $\theta$ = 5$\textdegree$, 9$\textdegree$ y 15$\textdegree$), y aplicando el error de la pendiente del ajuste, se obtuvo como resultado $g = 9{,}58 \pm 0{,}26 \frac{m}{s^2}$.
